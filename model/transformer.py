...
#             Rearrange('b c (ph h) (pw w) -> b c (ph pw) h w', c=in_channels, h=patch_size, ph=img_size // patch_size,
...
#
#         # start
#         self.attx = nn.Sequential(nn.Conv2d(8, 8, kernel_size=1),
#                                   nn.BatchNorm2d(8))
#         self.psixy = nn.Sequential(nn.Linear(257, 257),
#                                    nn.BatchNorm2d(8),
#                                    nn.Sigmoid())
#         # end
#
...
#         # start
#         queries = self.attx(queries)
#         keys = self.attx(keys)
#         # end
#         energy = torch.einsum('bhqd, bhkd -> bhqk', queries, keys)  # batch, num_heads, query_len, key_len
#
#         # start
#         energy = self.psixy(energy)
#
#         #
#
#         if mask is not None:
