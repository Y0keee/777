...
class TransMUNet(nn.Module):
    ...
    def __init__(self, n_classes=2,
        ...
        self.final = nn.ConvTranspose2d(64, 64, kernel_size=8,stride=4,padding=2)
        #end
    ...
    def forward(self, x, with_additional=False):
        ...
        # # x4_0 = a
        # # #end
        #print("ssss",np.shape(x))
        x0_0 = self.conv0_0(x)
        #print("111", np.shape(x0_0))
...
# F1 score (F-measure) or DSC: 0.8893893642100528
# 0it [00:00, ?it/s][[20848505   650164]
#  [  456178  4259553]]
# Accuracy: 0.957796401977539
# Specificity: 0.9697579417590921
# Sensitivity: 0.9032646264174101
# val_mode
# 4it [00:09,  2.38s/it]